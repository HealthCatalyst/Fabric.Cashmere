...
export class ModalSimpleOverviewExampleComponent {
    ...
    readonly icon = new FormControl('fa-solid fa-dollar-sign', {nonNullable: true});
    ...
    readonly confirmButtonIcon = new FormControl('fa-solid fa-dollar-sign', {nonNullable: true});
