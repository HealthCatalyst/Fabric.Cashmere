...
@NgModule({
    imports: [EllipsisPipeModule, NullOrEmptyStringPipeModule, FileSizePipeModule, NumberAbbreviatorPipeModule],
    exports: [EllipsisPipeModule, NullOrEmptyStringPipeModule, FileSizePipeModule, NumberAbbreviatorPipeModule]
})
