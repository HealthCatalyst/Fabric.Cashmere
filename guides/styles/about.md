...
<hc-modal>
    <div class="about-modal-content">
        ...
        <div class="about-reference">
            <div>
                <hc-icon fontSet="fa-solid" fontIcon="fa-cloud" hcIconLg></hc-icon>
                <div>
            ...
            <div>
                <hc-icon fontSet="fa-solid" fontIcon="fa-server" hcIconLg></hc-icon>
                <div>
            ...
            <div>
                <hc-icon fontSet="fa-solid" fontIcon="fa-database" hcIconLg></hc-icon>
                <div>
