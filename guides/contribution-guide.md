...
We would love for you to contribute to Cashmere and be part of the community making this project better! To get started, follow the [Getting Started guide](https://wcf-insurance.github.io/guides/getting-started).
...
7.  `npm start` will serve the default project which is `user-guide`
    :::
...
-   Run the following commands:
    ...
    -   `npm test` should result in `All tests passing`
...
-   A new component should adhere to the [WCF Insurance style](https://wcf-insurance.github.io).
-   When creating a PR you must set the base branch to dev(master is for release only) of the WCF Insurance repo (the default base branch is Health Catalyst).
