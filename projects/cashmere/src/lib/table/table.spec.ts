...
// import {HcSort, HcSortHeader, SortModule} from '../sort/index';
...
//   });
//
//   it('should render with HcTableDataSource and sort', () => {
...
//   });
//
//   it('should render with HcTableDataSource and pagination', () => {
...
//   }));
//
//   describe('with HcTableDataSource and sort/pagination/filter', () => {
//     let tableElement: HTMLElement;
//     let fixture: ComponentFixture<ArrayDataSourceMatTableApp>;
//     let dataSource: HcTableDataSource<TestData>;
...
//   dataSource = new HcTableDataSource<TestData>();
//   columnsToRender = ['column_a', 'column_b', 'column_c'];
//
//   @ViewChild(MatTable) table: MatTable<TestData>;
//   @ViewChild(MatPaginator) paginator: MatPaginator;
//   @ViewChild(HcSort) sort: HcSort;
//   @ViewChild(HcSortHeader) sortHeader: HcSortHeader;
//
//   constructor() {
