...
//   });
//
//   it('should throw an error if an HcSortable is not contained within an HcSort directive', () => {
...
//   });
//
//   it('should throw an error if an HcSortable is missing an id', () => {
...
//   });
//
//   it('should allow let HcSortable override the default sort parameters', () => {
...
//     inject([HcSortHeaderIntl], (intl: HcSortHeaderIntl) => {
//       const header = fixture.debugElement.query(By.directive(HcSortHeader)).nativeElement;
...
//  * the inputs and resets the HcSort to remove any side effects from previous tests.
//  */
...
//     component.sort(id);
//
//     // Check that the sort event's active sort is consistent with the HcSort
//     expect(component.matSort.active).toBe(id);
//     expect(component.latestSortEvent.active).toBe(id);
//
//     // Check that the sort event's direction is consistent with the HcSort
...
//
//   @ViewChild(HcSort) matSort: HcSort;
//   @ViewChild('defaultA') defaultA: HcSortHeader;
//   @ViewChild('defaultB') defaultB: HcSortHeader;
//   @ViewChild('overrideStart') overrideStart: HcSortHeader;
//   @ViewChild('overrideDisableClear') overrideDisableClear: HcSortHeader;
//
