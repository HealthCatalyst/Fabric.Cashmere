...
export function getFakeValues(search: string = '', count: number = 100): IValueOption[] {
    return getValues().filter(e => search ? e.title.toLocaleLowerCase().indexOf(search) > -1 : true).slice(0, count)
}
...
{ code: 'e176d119-77ca-4ceb-8427-b6589decf324', subValueCount: 10, subValues: [], title: 'Activation of Emergency Medical System Education' },
...
{ code: '489ac30a-3881-472e-9c6b-38728375a00d', subValueCount: 10, subValues: [], title: 'Additional evaluation for depression - adolescent' },
{ code: '2b3261f3-a26d-407d-98b5-0604e5e422d5', subValueCount: 10, subValues: [], title: 'Additional evaluation for depression - adult' },
{ code: '73dd818b-4372-4d81-9680-927ace969f6b', subValueCount: 10, subValues: [], title: 'Adhesions and Disruptions of Iris and Ciliary Body' },
...
{ code: 'deb44506-f9a2-4a02-86cd-9ebcafeb5b46', subValueCount: 10, subValues: [], title: 'Allergy to Tamoxifen or Aromatase Inhibitor Therapy' },
...
{ code: '41d48943-84d0-4446-a7ae-c9aa9ba21093', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Common Baker\'s Yeast' },
{ code: 'd4128c75-657d-4225-851a-9b26ae03cd49', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to DTaP Vaccine' },
{ code: '769f7108-f6d5-4e5a-9de5-cc4f8d9aa4e5', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Hemophilus Influenza B (HiB) Vaccine' },
{ code: '1348e6b3-ecc7-4a6c-9f4d-3f8c86396ba2', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Hepatitis A Vaccine' },
{ code: 'a90bd50c-af79-41a7-9c45-5f9b693abdaa', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Hepatitis B Vaccine' },
{ code: '40e8fd42-b4dd-4ad2-bc5e-790131fe2bdb', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Inactivated Polio Vaccine (IPV)' },
{ code: '80ae94ea-2b28-40a8-847f-e2c1fb4a81e7', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Influenza Vaccine' },
{ code: 'f8b95842-007f-4821-b563-34191a21b4e9', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Neomycin' },
{ code: '684d691c-c1f7-4bd7-8e34-b874af8e99c0', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Pneumococcal Conjugate Vaccine' },
{ code: 'd30a1b85-02eb-407f-b069-9b3fb50256ad', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Polymyxin' },
{ code: '1f0fbf75-ccab-49ac-8815-aa2111d70907', subValueCount: 10, subValues: [], title: 'Anaphylactic Reaction to Rotavirus Vaccine' },
...
{ code: '1e962c2f-e5c3-4be8-b0c9-ae48ecbc221d', subValueCount: 10, subValues: [], title: 'Any Infection Prior to Anesthesia Concepts' },
...
{ code: 'dbb720c2-e047-4377-bc63-d8b259078a56', subValueCount: 10, subValues: [], title: 'Atherosclerosis and Peripheral Arterial Disease' },
...
{ code: '21c03775-b91d-41ea-a032-cf7e3a9d709c', subValueCount: 10, subValues: [], title: 'BH Condition Involving Unipolar Depression' },
...
{ code: '91724ce7-30b0-4a5a-96a1-ba374226dbe9', subValueCount: 10, subValues: [], title: 'Bilateral amputation of leg below or above knee' },
...
{ code: 'b0cd865e-7999-493d-a3eb-917343c8f24c', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status N0' },
{ code: '7a8402b3-24c4-4ded-b942-12beaee0cfc8', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status N1' },
{ code: '3c5d6d6f-3b31-4e21-a12d-42df344f3653', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status N2' },
{ code: '1df422d1-bcdf-44a9-bb12-5e2422a36924', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status N3' },
{ code: '8753a7f4-7886-42f1-9876-8d5b4b5cacdc', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status pN1a' },
{ code: '177fce27-b328-41bc-a988-e8c8c0b52dc1', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status pN1b' },
{ code: 'a3395e5b-27dd-479f-bcfd-5501e577099d', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status pN1c' },
{ code: '3d7d33f3-7e8d-49b2-8cb8-442a7ee5dead', subValueCount: 10, subValues: [], title: 'Breast Cancer Regional Lymph Node Status pN1mi' }];
};