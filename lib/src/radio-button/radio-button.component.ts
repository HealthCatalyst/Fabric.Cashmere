...
export class RadioButtonComponent implements OnDestroy, OnInit {
    ...
    private readonly _unsubscribeFromNotifier: () => void = () => {
    };
    ...
    set checked(value: boolean) {
        ...
        if (this._checked !== newCheckedState) {
            ...
            if (newCheckedState) {
                this.notifierService.notify(this.id, this.name);
            }
    ...
    constructor(@Optional() radioGroup: RadioGroupDirective,
                ...
                private notifierService: RadioButtonNotifierService) {

        this.radioGroup = radioGroup;

        this._unsubscribeFromNotifier = notifierService.listen((id: string, name: string) => {
