...
/**
 * @title Table load more
 */
@Component({
    selector: 'table-load-more-example',
    templateUrl: 'table-load-more-example.html',
    styleUrls: ['table-load-more-example.css']
})
export class TableLoadMoreExample implements OnInit {
