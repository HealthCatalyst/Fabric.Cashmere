...
export class BarchartComponent implements OnInit {
    ...
    createChart() {
        ...
        this.xGroups = d3.scaleBand().padding(0.1).domain(xGroupDomain).rangeRound([0, this.xScale.bandwidth()]);
        ...
        this.xAxis = this.svg.append('g')
            ...
            .call(d3.axisBottom(this.xScale).tickSize(0).tickPadding(10));
        this.yAxis = this.svg.append('g')
            .attr('class', 'axis axis-y')
            .attr('transform', `translate(${this.margin.left}, ${this.margin.top})`)
            .call(d3.axisLeft(this.yScale).tickSizeInner(-this.width).tickSizeOuter(0).tickPadding(10));
    ...
    updateChart() {
        ...
        // update x & y axis
        this.xAxis.call(d3.axisBottom(this.xScale).tickSize(0).tickPadding(10));
        ...
        // add bar groups
        let bar = this.chart.selectAll('.bars')
            .data(this.data)
            .enter().append('g')
            .attr('class', 'group')
            .attr('name', d => d[0] )
            .attr('transform', function(d) { return 'translate(' + self.xScale(d[0]) + ',0)'; });
        ...
        bar.selectAll('rect')
            .on('mouseover', function(d, i) {
                ...
                self.tip.html('<div class="tooltip-header">' + barNames[i] + '</div>' + groupName + ': <strong>'  + d + '</strong>')
