...
/**
 * @title ScrollNav Example
 */
@Component({
    selector: 'hc-scroll-nav-example',
    templateUrl: 'scroll-nav-example.component.html',
    styleUrls: ['scroll-nav-example.component.scss'],
    standalone: false
})
export class ScrollNavExampleComponent {
    ...
    public hasScrollNavWithContent = true;
}
