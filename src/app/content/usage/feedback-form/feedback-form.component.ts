...
export class FeedbackFormComponent extends BaseDemoComponent implements OnInit {
    ...
    constructor(sectionService: SectionService, private fb: FormBuilder, private httpClient: HttpClient) {
