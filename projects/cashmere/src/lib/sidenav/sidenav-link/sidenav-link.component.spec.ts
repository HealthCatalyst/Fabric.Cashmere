...
class TestHostComponent {
    @ViewChild(SidenavLinkComponent)
    public navbarLinkComponent: SidenavLinkComponent;
}
describe('NavbarLinkComponent', () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            imports: [RouterModule.forRoot([{path: '', component: SidenavLinkComponent}])],
            declarations: [SidenavLinkComponent, TestHostComponent],
    ...
    it('should return the item width', () => {
        const link = testHostFixture.debugElement.query(By.directive(SidenavLinkComponent));
