  ...
  describe('positioning', () => {
    ...
    it('should realign when the anchor moves', fakeAsync(() => {
      ...
      const centerOfPopover = () => getCenter(overlayContainerElement
        .querySelector('.hc-popover-container')
...
@Component({
  template: `
    <hc-popover horizontalAlign="after">Anchorless</hc-popover>
  `
})
...
@Component({
  template: `
    ...
    <hc-popover #p>Popover</hc-popover>
  `
})
...
@Component({
  template: `
    <div [hcPopoverAnchorFor]="p">Anchor</div>
    <hc-popover #p (overlayKeydown)="lastKeyCode = $event.keyCode">
      Popover
...
@Component({
  template: `
    <div [hcPopoverAnchorFor]="p">Anchor</div>
    <hc-popover #p [xAlign]="xAlign" [yAlign]="yAlign">
      Popover
    </hc-popover>
  `
})
...
@Component({
  template: `
    <div [hcPopoverAnchorFor]="p">Anchor</div>
    <hc-popover #p [scrollStrategy]="strategy">
      Popover
    </hc-popover>
  `
})
