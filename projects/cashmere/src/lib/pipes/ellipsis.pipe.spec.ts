...
describe('EllipsisPipe', () => {
    ...
    it('Should truncate string', inject([EllipsisPipe], pipe => {
        // arrange
    ...
    it('Should not truncate a short string', inject([EllipsisPipe], pipe => {
        // arrange
    ...
    it('Should return string if arg is undefined', inject([EllipsisPipe], pipe => {
        // arrange
        const testString: string = 'A long string';
    ...
    it('Should return same value if falsey', inject([EllipsisPipe], pipe => {
        // arrange
